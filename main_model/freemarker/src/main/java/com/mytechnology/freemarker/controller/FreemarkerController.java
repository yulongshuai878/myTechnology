package com.mytechnology.freemarker.controller;

import com.mytechnology.freemarker.utils.FreemarkerUtil;
...
public class FreemarkerController {
    ...
    public String createHtml(Model model){
        ...
        model.addAttribute("dateObj", new Date());
        model.addAttribute("bol", true);
        return FreemarkerUtil.parseTpl("freemarker", model.asMap());
    }
}
